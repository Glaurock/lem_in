...
void					draw_line(t_env *env, t_point *ini_point,
							t_point *final_point);
...
double					map(double nb, double min,
							double slope, double new_min);
...
void					push_list(t_list_point **head,
							int x, int y, char *name);
void					push_edges(t_list_edges **head,
							char *node1, char *node2);
